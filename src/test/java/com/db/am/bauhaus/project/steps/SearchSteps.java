...
public class SearchSteps {
    ...
    @When("^he search for a \"([^\"]*)\" from the Navigation menu$")
    public void he_search_for_a_from_the_Navigation_menu(String product) throws Throwable {
        mainSearchPage.selectElementFromNavigationMenu("Jewellery", "Bracelets", product);
    }

    @When("^he search for a \"([^\"]*)\" from the product icons$")
    public void he_search_for_a_from_the_product_icons(String product) throws Throwable {
        mainSearchPage.selectElementFromProductIcons("Jewellery", "Necklaces", product);
    }


    @Then("^he should see \"([^\"]*)\" product page$")
    public void he_should_see_product_page(String product) throws Throwable {
        user.verify_result_page(product);
    }
